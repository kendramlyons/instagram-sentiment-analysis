...
This script performs a sentiment analysis task on text from Instagram posts that use any of the following hashtags: #grassroots, #communityorganization/s, #filibuster, #protest/s,
#mutualaid, #socialmovement/s
It also defines functions for cleaning text scraped from Instagram and performs a baseline sentiment analysis 
classification task.
'''
...
cv = CountVectorizer(ngram_range=(1,1), max_df = .8) # not much changes when bigrams are added, stop_words="english" improve pos, make neu/neg acuracy worse
